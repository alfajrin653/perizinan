...
import { IdCard, CreditCard, FileText, Image as ImageIcon, MapPin, CheckCircle2 } from "lucide-react";
  ...
  const requirements = [
    {
      icon: IdCard,
      title: "E-KTP Pendiri",
      desc: "Fotokopi/scan KTP seluruh pemegang saham dan pengurus (minimal 2 orang).",
    },
    {
      icon: CreditCard,
      title: "NPWP Pribadi",
      desc: "Fotokopi/scan NPWP pribadi seluruh pemegang saham dan pengurus.",
    },
    {
      icon: FileText,
      title: "Kartu Keluarga (KK)",
      desc: "Fotokopi/scan Kartu Keluarga (KK) khusus untuk Direktur Utama.",
    },
    {
      icon: ImageIcon,
      title: "Pas Foto",
      desc: "Pas foto berwarna Direktur Utama ukuran 3x4 atau 4x6 (latar belakang merah).",
    },
    {
      icon: MapPin,
      title: "Bukti Domisili Usaha",
      desc: "Sewa Virtual Office di kami? Syarat ini otomatis SELESAI. Anda tidak perlu repot mencari dokumen sewa gedung/PBB.",
      highlight: true, // Untuk memberikan style khusus pada poin ini
    },
  ];
