                  ...
                  <div className='grid grid-cols-3 gap-6 text-sm'>
                    <div>
                      ...
                      <ul className='space-y-2 text-gray-600'>
                        ...
                        <li>
                          <a href='/coworking-space' className='block hover:text-blue-600 transition-colors'>
                            Coworking Space
                          </a>
                        </li>
                      </ul>
                    ...
                    <div>
                      ...
                      <ul className='space-y-2 text-gray-600'>
                        <li>
                          <a href='/pendirian-pt' className='block hover:text-blue-600 transition-colors'>
                            Pendirian PT
                          </a>
                        </li>
                        <li>
                          <a href='/pendirian-cv' className='block hover:text-blue-600 transition-colors'>
                            Pendirian CV
                          </a>
                        </li>
                        <li>
                          <a href='/pendirian-firma' className='block hover:text-blue-600 transition-colors'>
                            Pendirian Firma
                          </a>
                        </li>
                        <li>
                          <a href='/pendaftaran-haki' className='block hover:text-blue-600 transition-colors'>
                            HaKI
                          </a>
                        </li>
                        <li>
                          <a href='/pajak-akuntansi' className='block hover:text-blue-600 transition-colors'>
                            Pajak & Akuntansi
                          </a>
                        </li>
                        <li>
                          <a href='/call-answering' className='block hover:text-blue-600 transition-colors'>
                    ...
                    <div>
                      ...
                      <ul className='space-y-2 text-gray-600'>
                        <li>
                          <a href='/pendirian-pma' className='block hover:text-blue-600 transition-colors'>
                            Pendirian PMA
                          </a>
                        </li>
                        <li>
                          <a href='/internasional-business' className='block hover:text-blue-600 transition-colors'>
                            International Setup
                          </a>
                        </li>
                        <li>
                          <a href='/visa-bisnis' className='block hover:text-blue-600 transition-colors'>
                            Visa Bisnis
                          </a>
                        </li>
                        <li>
                          <a href='/kitas-investor' className='block hover:text-blue-600 transition-colors'>
                            Visa Investor / KITAS
                          </a>
                        </li>
                        <li>
                          <a href='/visa-turis' className='block hover:text-blue-600 transition-colors'>
                            Visa Turis
                          </a>
                        </li>
                      </ul>
