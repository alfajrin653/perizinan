...
import { PlaneTakeoff, Globe, FileCheck, Building, ShieldCheck, Clock, UserCheck } from 'lucide-react';
...
export default function VisaBusinesspages() {
  ...
  const visaPackages = [
    {
      ...
      featured: false,
      features: ['Masa Tinggal 60 Hari', 'Dokumen Sponsor Perusahaan', 'Penyusunan Surat Undangan', 'Pengurusan di Imigrasi', 'Dukungan Dokumen Terjemahan'],
      bonuses: ['Konsultasi Ekspatriat', 'Bantuan Ekstensi Visa'],
    },
    {
      ...
      featured: true,
      features: ['Berlaku hingga 1 Tahun', 'Bebas Keluar-Masuk Indonesia', 'Dokumen Sponsor Perusahaan', 'Penyusunan Surat Undangan', 'Jalur Cepat Imigrasi (Opsional)'],
      bonuses: ['Layanan Antar-Jemput Dokumen', 'Konsultasi Rencana Investasi', 'Prioritas Customer Support'],
    },
  ];
  ...
  const visaFaqs = [
    {
      ...
      answer:
        'Anda memerlukannya jika ingin melakukan aktivitas berikut: menghadiri pertemuan/konferensi bisnis, negosiasi atau tanda tangan kontrak, riset pasar/studi kelayakan, menghadiri pameran dagang, mengikuti program pelatihan/workshop, atau mendirikan/menjalankan kegiatan usaha di Indonesia.',
    },
    {
      question: 'Siapa yang bisa mendapatkan Visa Bisnis Indonesia?',
      answer:
        'Mayoritas warga negara asing dapat memperolehnya. Namun, perlu diingat bahwa ada sejumlah negara terlarang (Calling Visa) yang permohonannya mungkin ditolak, antara lain: Afghanistan, Kamerun, Guinea, Israel, Irak, Liberia, Nigeria, Uzbekistan, Korea Utara, dan Somalia.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Terdapat dua jenis utama: (1) Visa Bisnis Sekali Masuk (Single Entry) yang memungkinkan masuk 1 kali dan akan hangus setelah Anda meninggalkan Indonesia. (2) Visa Bisnis Banyak Masuk (Multiple Entry) yang memungkinkan Anda masuk dan keluar Indonesia beberapa kali selama masa berlaku tanpa perlu mengajukan visa baru.',
    },
    {
      question: 'Apa saja persyaratan untuk pengajuan Visa Bisnis Indonesia?',
      answer:
        'Syarat utama meliputi: Paspor yang sah, Formulir Permohonan, Foto seukuran paspor, Surat Undangan, Dokumen Bisnis (Sponsor), Rencana Perjalanan Penerbangan, Sarana Keuangan (Bukti Rekening), Asuransi Perjalanan, dan Surat Keterangan Kerja.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Kunjungi kantor imigrasi setidaknya satu minggu sebelum visa habis. Isi formulir perpanjangan, siapkan dokumen pendukung (paspor, visa, surat sponsor), bayar biaya perpanjangan, serahkan ke petugas imigrasi, dan tunggu persetujuan selesai.',
    },
  ];
  ...
  return (
    <div className='w-full bg-white'>
      ...
      <section className='py-24 bg-slate-50'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-slate-900'>Paket Layanan Visa Bisnis</h2>
            <p className='text-slate-600'>Solusi pengurusan izin masuk (Entry Permit) yang disesuaikan dengan intensitas kunjungan dan kebutuhan operasional perusahaan Anda.</p>
          </div>

          <div className='grid md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
            {visaPackages.map((pkg, index) => (
              <CompanyPackageCard key={index} name={pkg.name} price={pkg.price} badge={pkg.badge} desc={pkg.desc} featured={pkg.featured} features={pkg.features} bonuses={pkg.bonuses} />
            ))}
          </div>
        </div>
      </section>
      ...
      {/* 3. FAQ SECTION */}
      <FAQ faqs={visaFaqs} title='FAQ Seputar Visa Bisnis Indonesia' subtitle='Panduan lengkap dan jawaban untuk kelancaran mobilitas bisnis Anda ke Indonesia.' />
    </div>
  );
}
