...
import { PlaneTakeoff, Users, Clock, ShieldCheck, CheckCircle2 } from 'lucide-react';
...
export default function VisaTuris() {
  ...
  const turisPackages = [
    {
      ...
      featured: false,
      features: ['E-Visa Kunjungan (Index B211A)', 'Masa Tinggal 60 Hari', 'Penyediaan Dokumen Sponsor', 'Proses Normal (7-10 Hari Kerja)'],
      bonuses: ['Customer Support Dedicated', 'Bantuan Ekstensi / Perpanjangan'],
    },
    {
      ...
      featured: true,
      features: ['E-Visa Kunjungan (Index B211A)', 'Masa Tinggal 60 Hari', 'Penyediaan Dokumen Sponsor', 'Proses Kilat (3-5 Hari Kerja)'],
      bonuses: ['Layanan Prioritas VIP', 'Customer Support Dedicated', 'Bantuan Ekstensi / Perpanjangan'],
    },
  ];
  ...
  const turisFaqs = [
    ...
    },
    {
      ...
      answer:
        'Tidak. Visa Turis B211A adalah Single Entry (sekali masuk). Jika Anda keluar dari wilayah Indonesia (misalnya ke Singapura atau Malaysia), maka visa tersebut akan otomatis hangus, dan Anda harus membuat visa baru jika ingin masuk kembali ke Indonesia.',
    },
    {
      question: 'Kapan saya harus memperpanjang visa saya?',
      answer:
        'Kami sangat menyarankan Anda untuk mulai memproses perpanjangan (ekstensi) visa setidaknya 7 hingga 10 hari sebelum masa berlaku 60 hari pertama Anda habis. Keterlambatan perpanjangan (Overstay) akan dikenakan denda sebesar Rp 1.000.000 per hari oleh pihak Imigrasi.',
    },
  ];
  ...
  return (
    <div className='w-full bg-white'>
      ...
      <FeatureSection
        ...
        buttonText='Konsultasi Visa Sekarang'
      ...
      <section className='py-16 bg-white border-t border-slate-100'>
        <div className='max-w-5xl mx-auto px-6 lg:px-8'>
          <div className='mb-10'>
            <h2 className='text-2xl md:text-3xl font-bold text-slate-900 mb-2'>Persyaratan Dokumen Visa Turis</h2>
            <p className='text-slate-600'>Persiapkan dokumen digital berikut, dan kami akan menangani seluruh proses pengajuannya ke sistem Imigrasi.</p>
          </div>
      ...
      <section className='py-24 bg-slate-50'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-slate-900'>Paket Pengurusan Visa Turis</h2>
            <p className='text-slate-600'>Pilih layanan reguler atau kilat. Semua paket sudah termasuk biaya resmi ke negara dan penyediaan dokumen sponsor.</p>
          </div>

          <div className='grid md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
            {turisPackages.map((pkg, index) => (
              <CompanyPackageCard key={index} title={pkg.title} price={pkg.price} badge={pkg.badge} desc={pkg.desc} featured={pkg.featured} features={pkg.features} bonuses={pkg.bonuses} />
            ))}
          </div>
        </div>
      </section>
      ...
      {/* 4. FAQ SECTION */}
      <FAQ faqs={turisFaqs} title='FAQ Seputar Visa Turis Indonesia' subtitle='Temukan jawaban penting mengenai izin tinggal wisata dan batasan kegiatannya.' />
    </div>
  );
}
