...
import { 
  ...
  MapPin, CheckCircle2, TrendingUp, Handshake,
  ...
  const internationalFaqs = [
    {
      ...
      answer: "Tidak perlu. Hampir seluruh yurisdiksi yang kami tawarkan memungkinkan proses inkorporasi (pendirian perusahaan) secara 100% remote tanpa kehadiran fisik Anda. Semua dokumen dapat diproses secara elektronik atau dikirim via kurir internasional."
    },
    {
      question: "Bagaimana dengan pembukaan rekening bank korporat?",
      answer: "Kami bekerja sama dengan berbagai bank digital dan bank tradisional internasional (seperti di Singapura, Hong Kong, atau EMI di Eropa). Sebagian besar proses wawancara bank saat ini dapat dilakukan melalui Video Call. Kami akan mendampingi dan menyiapkan profil perusahaan Anda agar mudah disetujui oleh bank."
    },
    {
    ...
    },
    {
      ...
      answer: "Penghasilan perusahaan di luar negeri tunduk pada aturan pajak negara tersebut. Namun, jika dividen ditarik ke Indonesia oleh Anda sebagai Warga Negara Indonesia (Subjek Pajak Dalam Negeri), dividen tersebut harus dilaporkan di SPT Tahunan Pribadi Anda. Kami menyarankan untuk berkonsultasi lebih lanjut dengan tim pajak kami."
    },
    {
      question: "Berapa lama proses pendirian perusahaan internasional?",
      answer: "Waktu proses bervariasi. Negara seperti Singapura atau BVI bisa selesai dalam 3-5 hari kerja. Hong Kong memakan waktu sekitar 1-2 minggu, sementara Dubai (Free Zone) bisa memakan waktu 2-4 minggu. Waktu ini dihitung setelah semua dokumen persyaratan lengkap."
    }
  ];
  ...
  return (
    <div className="w-full bg-white">
      ...
      <FeatureSection 
        ...
        buttonText="Mulai Ekspansi Global"
        buttonLink="/konsultasi-global"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Partner Global yang Bisa Diandalkan
            </h2>
            <p className="text-slate-600">
              Menembus batas negara bukan hal yang sulit jika Anda dibantu oleh tim yang tepat.
            </p>
          </div>
      ...
      <FAQ 
        ...
        title="FAQ Setup Bisnis Internasional"
        subtitle="Temukan jawaban atas keraguan Anda sebelum melangkah ke pasar global."
      />
