...
import { Globe, Briefcase, Landmark, ShieldCheck, CheckCircle2 } from 'lucide-react';
  ...
  const kitasPackages = [
    {
      ...
      featured: false,
      features: ['E-Visa Investor (Index 313)', 'E-KITAS (Izin Tinggal Terbatas 1 Tahun)', 'Multiple Exit Re-entry Permit (MERP)', 'Laporan Keberadaan Kepolisian (STM)', 'Surat Keterangan Tempat Tinggal (SKTT)'],
      bonuses: ['Bebas Biaya DPKK / Pajak TKA', 'Pengurusan Tanpa RPTKA'],
    },
    {
      ...
      featured: true,
      features: ['E-Visa Investor (Index 314)', 'E-KITAS (Izin Tinggal Terbatas 2 Tahun)', 'Multiple Exit Re-entry Permit (MERP)', 'Laporan Keberadaan Kepolisian (STM)', 'Surat Keterangan Tempat Tinggal (SKTT)'],
      bonuses: ['Bebas Biaya DPKK / Pajak TKA', 'Pengurusan Tanpa RPTKA', 'Prioritas Dokumen Imigrasi'],
    },
  ];
  ...
  const kitasFaqs = [
    {
      ...
      answer:
        'Keuntungan terbesarnya adalah pemegang KITAS Investor dibebaskan dari kewajiban membayar Dana Kompensasi Penggunaan Tenaga Kerja Asing (DPKK) sebesar $1.200 per tahun. Selain itu, prosesnya lebih cepat karena tidak memerlukan pengesahan RPTKA (Rencana Penggunaan Tenaga Kerja Asing) dari Kementerian Ketenagakerjaan.',
    },
    {
      question: 'Siapa saja yang berhak mengajukan KITAS Investor?',
      answer:
        'WNA yang tercatat sebagai pemegang saham di Akta Perusahaan PT PMA dan menjabat sebagai Direktur atau Komisaris. WNA yang hanya menjadi pemegang saham (tanpa jabatan direksi) juga bisa mengajukan, asalkan nilai saham yang disetor minimum Rp 1.125.000.000 (Satu Miliar Seratus Dua Puluh Lima Juta Rupiah).',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Pemegang KITAS Investor yang menjabat sebagai Direktur diperbolehkan melakukan kegiatan manajerial sesuai jabatannya. Namun, bagi pemegang KITAS Investor yang menjabat sebagai Komisaris atau hanya pemegang saham, mereka tidak diizinkan untuk bekerja secara operasional di Indonesia.',
    },
    {
    ...
    <div className='w-full bg-white'>
      ...
      <section className='py-16 bg-white border-t border-slate-100'>
        <div className='max-w-5xl mx-auto px-6 lg:px-8'>
          <div className='mb-10'>
            <h2 className='text-2xl md:text-3xl font-bold text-slate-900 mb-2'>Persyaratan Dokumen</h2>
            <p className='text-slate-600'>Siapkan dokumen dasar berikut, dan tim ahli kami akan memproses sisanya ke Imigrasi.</p>
          </div>
      ...
      <section className='py-24 bg-slate-50'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-slate-900'>Paket Pengurusan KITAS Investor</h2>
            <p className='text-slate-600'>Pilih masa berlaku E-Visa dan E-KITAS sesuai dengan kebutuhan rencana jangka panjang investasi Anda di Indonesia.</p>
          </div>
      ...
      {/* 4. FAQ SECTION */}
      <FAQ faqs={kitasFaqs} title='FAQ Seputar KITAS Investor' subtitle='Pertanyaan yang sering diajukan mengenai izin tinggal bagi penanam modal asing di Indonesia.' />
    </div>
  );
}
