...
export default function HubungiKami() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: PhoneCall,
      title: "Telepon",
      desc: "+62 21 2922 2999",
    },
    {
      icon: MessageCircle,
      title: "WhatsApp",
      desc: "+62 812-8000-0000", 
    },
    {
      icon: Mail,
      title: "Email",
      desc: "cs@voffice.co.id",
    },
    {
      icon: Clock,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600">
            Punya pertanyaan seputar layanan kami atau butuh konsultasi khusus? Jangan ragu untuk menghubungi tim ahli kami. Kami siap membantu membesarkan bisnis Anda.
          </p>
        </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50">
              ...
              <p className="text-slate-500 mb-8">
                Isi formulir di bawah ini dan perwakilan kami akan segera menghubungi Anda.
              </p>
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      type="text" 
                      name="user_name" // PENTING: Atribut 'name' ini harus sesuai dengan variabel di EmailJS Template
                ...
                <button 
                  ...
                  className={`w-full font-bold py-4 rounded-xl transition shadow-lg flex items-center justify-center gap-2 ${
                    status === "success" 
                      ...
                      : "bg-blue-600 hover:bg-blue-700 text-white shadow-blue-200 disabled:opacity-70 disabled:cursor-not-allowed"
                  }`}
                >
                  {status === "loading" ? (
                    <>
  ...
  <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
    <div className="px-8 py-6 border-b border-slate-200">
      ...
      <p className="text-slate-600 mt-2">
        Kunjungi kantor kami atau gunakan Google Maps untuk mendapatkan
        petunjuk arah.
      </p>
    </div>
