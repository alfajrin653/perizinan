...
import { Globe, Building2, Briefcase, Scale, CheckCircle2 } from 'lucide-react';
...
export default function PendirianPma() {
  ...
  const pmaPackages = [
    {
      ...
      featured: false,
      features: ['Pengecekan & Pemesanan Nama PT PMA', 'Akta Pendirian Notaris (Bilingual)', 'SK Pengesahan Kemenkumham', 'NIB (Nomor Induk Berusaha) via OSS', 'NPWP & SKT Perusahaan PMA'],
    ...
    },
    {
      ...
      featured: true,
      features: ['Semua kelengkapan legalitas PMA Dasar', 'Pengurusan 1 KITAS Investor / Direktur', 'Penyusunan RPTKA (Tenaga Kerja Asing)', 'Pendampingan Pembukaan Rekening Bank', 'Konsultasi Regulasi Daftar Positif Investasi'],
      bonuses: ['Virtual Office Premium (1 Tahun)', 'Nomor Telepon Perusahaan Khusus', 'Kuota Meeting Room (15 Jam/Bulan)'],
    },
  ];
  ...
  const pmaFaqs = [
    ...
    },
    {
      ...
      answer:
        'Ya, bisa. Berdasarkan Daftar Positif Investasi (DPI) terbaru, banyak sektor usaha di Indonesia yang kini terbuka untuk 100% kepemilikan asing. Namun, beberapa sektor tertentu mungkin masih mewajibkan adanya kepemilikan saham lokal (Joint Venture).',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Untuk keperluan administrasi domisili dan pendaftaran NIB, Anda bisa menggunakan layanan Virtual Office di zona komersial yang sah (seperti yang kami sediakan). Namun, untuk aktivitas produksi atau operasional tertentu, pemerintah mungkin mewajibkan keberadaan kantor fisik atau pabrik.',
    },
  ];
  ...
  return (
    <div className='w-full bg-white'>
      ...
      <section className='py-24 bg-slate-50'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-slate-900'>Paket Pendirian Perusahaan PMA</h2>
            <p className='text-slate-600'>Pilih layanan pendirian investasi asing yang sesuai dengan rencana ekspansi bisnis Anda di Indonesia.</p>
          </div>
      ...
      {/* 3. FAQ SECTION */}
      <FAQ faqs={pmaFaqs} title='FAQ Pendirian PT PMA' subtitle='Informasi krusial yang perlu diketahui oleh investor asing sebelum mendirikan perusahaan di Indonesia.' />
    </div>
  );
}
