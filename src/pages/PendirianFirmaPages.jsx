...
export default function PendirianFirma() {
  ...
  const firmaFaqs = [
    {
      ...
      answer: "Perbedaan utamanya ada pada tanggung jawab. Pada Firma, seluruh sekutu (pendiri) memiliki tanggung jawab renteng yang tidak terbatas hingga ke harta pribadi jika terjadi kerugian. Sedangkan PT memiliki tanggung jawab terbatas pada modal yang disetor, dan CV memisahkan antara sekutu aktif dan pasif."
    },
    {
      question: "Siapa yang cocok mendirikan badan usaha Firma?",
      answer: "Firma sangat cocok untuk persekutuan bisnis yang mengandalkan keahlian profesi dan kepercayaan tinggi antar pendiri, seperti kantor konsultan hukum, kantor akuntan, atau agen jasa tertentu di mana para pendiri menggunakan satu nama bersama."
    },
    {
  ...
  return (
    <div className="w-full bg-white">
      ...
      {/* 5. FAQ SECTION */}
      <FAQ 
        title="Pertanyaan Seputar Firma"
        subtitle="Informasi penting mengenai legalitas dan karakteristik badan usaha Firma."
        faqs={firmaFaqs} 
      />
