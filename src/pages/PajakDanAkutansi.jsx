...
import { Calculator, CalendarCheck, ShieldCheck, Award, MessageSquare, FolderOpen, FileSpreadsheet, Send, TrendingUp } from 'lucide-react';
...
export default function PajakDanAkuntansi() {
  ...
  const taxPackages = [
    {
      ...
      featured: false,
      features: ['Lapor SPT Masa PPh (21, 23, 4 ayat 2)', 'Lapor SPT Masa PPN (E-Faktur)', 'Pembuatan ID Billing Pajak', 'Bukti Penerimaan Elektronik (BPE)', 'Reminder Jatuh Tempo Pajak'],
      bonuses: ['Konsultasi Pajak Ringan', 'Update Peraturan Pajak Terbaru'],
    },
    {
      ...
      featured: true,
      features: ['Semua fitur Tax Reporting Bulanan', 'Penyusunan Jurnal Transaksi Bulanan', 'Laporan Laba/Rugi (Income Statement)', 'Laporan Neraca (Balance Sheet)', 'Rekonsiliasi Rekening Koran'],
      bonuses: ['Review Kesehatan Keuangan', 'Bantuan Draft SPT Tahunan Badan', 'Dedicated Tax Consultant'],
    },
  ];
  ...
  const taxFaqs = [
    {
      ...
      answer:
        "Tentu. Berdasarkan regulasi, perusahaan yang sudah ber-NPWP dan dikukuhkan secara legal tetap diwajibkan melapor SPT Masa (pajak bulanan) dengan status 'Nihil' meskipun belum ada transaksi. Keterlambatan pelaporan SPT Nihil tetap dikenakan denda administratif oleh DJP.",
    },
    {
      question: 'Apa perbedaan layanan Akuntansi (Pembukuan) dan Pajak?',
      answer:
        'Akuntansi berfokus pada pencatatan transaksi untuk menghasilkan Laporan Keuangan (Laba Rugi, Neraca) agar Anda tahu performa bisnis. Sedangkan Perpajakan menggunakan data dari laporan keuangan tersebut untuk menghitung, menyetor, dan melaporkan kewajiban pajak ke negara sesuai undang-undang.',
    },
    {
  ...
  return (
    <div className='w-full bg-white'>
      ...
      {/* 2. PROSES LAYANAN */}
      <ProcessTimeline title='Alur Kerja Layanan Pajak & Akuntansi' subtitle='Proses yang terstruktur untuk memastikan data keuangan Anda diproses dengan akurat, rapi, dan tepat waktu setiap bulannya.' steps={taxSteps} />
      ...
      <section className='py-24 bg-slate-50'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-slate-900'>Paket Layanan Pajak & Pembukuan</h2>
            <p className='text-slate-600'>Pilih paket yang paling sesuai dengan fase bisnis Anda saat ini. Transparan, tanpa biaya tersembunyi, dan jauh lebih efisien daripada merekrut tim internal.</p>
          </div>
      ...
      {/* 5. FAQ SECTION */}
      <FAQ faqs={taxFaqs} title='FAQ Seputar Pajak & Akuntansi' subtitle='Temukan jawaban atas pertanyaan umum terkait kewajiban pajak perusahaan dan layanan pembukuan kami.' />
    </div>
  );
}
