...
import { PhoneCall, UserCheck, Forward, Mail, Headphones, Voicemail, Smartphone, Clock, MessageSquare, Contact } from 'lucide-react';
...
export default function CallCenterPages() {
  ...
  const callPackages = [
    {
      ...
      featured: false,
      features: ['Nomor Telepon Perusahaan (Shared)', 'Penerimaan Telepon oleh Resepsionis', 'Pencatatan Pesan (Message Taking)', 'Notifikasi Pesan via Email', 'Layanan Hari Kerja (08:00 - 17:00)'],
      bonuses: ['Free Setup Fee', 'Akses Layanan vOffice Lainnya'],
    },
    {
      ...
      featured: true,
      features: ['Nomor Telepon Eksklusif (Dedicated)', 'Sapaan Khusus (Nama Perusahaan Anda)', 'Penyambungan Telepon (Call Transfer)', 'Pencatatan Pesan & Voicemail', 'Layanan Hari Kerja (08:00 - 17:00)'],
      bonuses: ['Notifikasi Cepat via WhatsApp', 'Pengaturan Nomor Ekstensi (Opsional)', 'Laporan Panggilan Bulanan'],
    },
  ];
  ...
  const callFaqs = [
    {
      ...
      answer:
        "Jika Anda menggunakan layanan Dedicated Phone Number, resepsionis kami akan menyapa penelepon dengan nama perusahaan Anda. Contoh: 'Selamat pagi, dengan PT Sukses Makmur, ada yang bisa kami bantu?' Anda juga bisa menentukan script sapaan khusus.",
    },
    {
  ...
  return (
    <div className='w-full bg-white'>
      ...
      {/* 2. PROSES LAYANAN */}
      <ProcessTimeline title='Cara Kerja Call Answering' subtitle='Sistem telekomunikasi yang cerdas dan mulus, memastikan Anda tetap terhubung dengan klien tanpa harus selalu berada di depan meja.' steps={callSteps} />
      ...
      <section className='py-24 bg-slate-50'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-slate-900'>Paket Layanan Call Answering</h2>
            <p className='text-slate-600'>Pilih paket penjawab telepon yang sesuai dengan kebutuhan komunikasi bisnis Anda. Hemat biaya operasional dibanding merekrut resepsionis purna waktu.</p>
          </div>
      ...
      {/* 5. FAQ SECTION */}
      <FAQ faqs={callFaqs} title='FAQ Seputar Call Answering' subtitle='Pelajari lebih lanjut tentang bagaimana layanan penjawab telepon kami dapat mengoptimalkan operasional Anda.' />
    </div>
  );
}
